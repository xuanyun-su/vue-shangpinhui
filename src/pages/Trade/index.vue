  ...
  <div class="trade-container">
    ...
    <div class="money clearFix">
      <ul>
        ...
        <li>
          <b>返现：</b>
          <span>{{
            orderInfo.originalTotalAmount2 - orderInfo.totalAmount
          }}</span>
        </li>
        <li>
          <b>运费：</b>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ userDefault.fullAddress || "无" }}</span>
        收货人：<span>{{ userDefault.consignee || "无" }}</span>
    ...
    async submitOrder() {
     ...
     if(result.code===200){
       this.orderId = result.data
        this.$router.push("/pay?ordered="+this.orderId)
     }else{
       alert(result.data)
     }
    },
